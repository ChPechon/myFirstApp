...
import 'package:gradapp/components/result_button.dart';
import 'package:gradapp/const.dart';
import 'package:gradapp/models/model_8.dart';
import 'package:gradapp/models/score_model.dart';
import 'package:gradapp/pages/page_7.dart';
import 'package:gradapp/pages/result_page.dart';
...
class PageEight extends StatefulWidget {
  ...
  @override
  State<PageEight> createState() => _GradPageState();
}

class _GradPageState extends State<PageEight> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(
          child: Text(
            'การดูแลขั้นต่ําที่ควรจะได้รับ (8/8)',
            style: TextStyle(
              color: Colors.black,
            ),
          ),
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: const Center(
              child: Column(
                children: [
                  Text(
                    'ความต้องการการบรรเทาอาการรบกวน',
          ...
          Consumer<ScoreModel>(builder: (context, scoreModel, child) {
            return GradCard(content: EightModel(choice: context.read<ScoreModel>().score.last));
          }),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              PreviousButton(PreviousPage: const PageSeven()),
              ResultButton(nextPage: const ResultPage()),
            ],
          ),
        ],
      ),
