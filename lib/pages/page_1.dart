...
class PageOne extends StatefulWidget {
  ...
  @override
  State<PageOne> createState() => _GradPageState();
}

class _GradPageState extends State<PageOne> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(
          child: Text(
            'ตัวบ่งชี้สภาวะความเจ็บป่วย (1/8)',
            style: TextStyle(
              color: Colors.black,
            ),
          ),
      ...
      body: Column(
        children: [
          ...
          Consumer<ScoreModel>(builder: (context, scoreModel, child) {
            return GradCard(content: OneModel(choice: context.read<ScoreModel>().score.last));
          }),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              NextButton(nextPage: const PageTwo()),
            ],
          ),
        ],
      ),
